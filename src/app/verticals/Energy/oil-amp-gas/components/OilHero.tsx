...
export default function ElectricHero() {
  return (
    <section className="relative w-full min-h-125 h-auto sm:min-h-150 lg:h-150 flex items-center bg-slate-900 overflow-hidden py-16 lg:py-0">
      <Image
        src="/images/oil-amp-gas/OilandGasHerobg.png"
        alt="Electric Hero"
        fill
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:mt-20">
        <div className="max-w-2xl text-white">
          ...
          <p className="text-xs sm:text-sm md:text-base mb-6 sm:mb-8 text-slate-100 max-w-300 lg:w-3xl drop-shadow-gray-600 drop-shadow-2xl leading-relaxed">
            Today&apos;s challenges call for squeezing out cost while adding
            flexibility and automation with oil and gas technology solutions
            built on digital technologies. Deriving data insights from
            artificial intelligence (AI) helps improve operational efficiency by
            making processes more predictive, automated and productive. These
            insights from big data form the basis for building new adaptable
            workflows that revolutionize how work gets done
          </p>
        </div>
      </div>
    </section>
