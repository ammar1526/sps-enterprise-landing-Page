...
const cards: CardData[] = [
  {
    heading: "Transform How Your Textile Company Serves Its People",
    paragraph:
  ...
  {
    heading:
      "Helping Textile Companies Accelerate Digital Transformation with AI, Cloud, and Cybersecurity",
    paragraph:
