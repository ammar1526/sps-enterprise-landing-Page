  ...
  return (
    <>
      <section className="relative w-full min-h-150 flex items-center bg-slate-900 overflow-hidden">
        <Image
          src="/images/manufacturing/Manufactureherobg.jpg"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            <div className="text-white text-center lg:text-left">
              ...
              <p className="text-sm sm:text-base mb-8 text-slate-100 max-w-3xl mx-auto lg:mx-0 drop-shadow-black drop-shadow-2xl">
                Unforeseen manufacturing equipment failure, high maintenance
                costs, and a lack of data integration due to disparate systems
                are all detrimental to operational efficiency. Analytics and IoT
                solutions that offer centralized monitoring, predictive
                maintenance, and connected logistics help combat these
                challenges. Leveraging the power of data along with process
                automation, Analytics and IoT solutions help advance the
                manufacturing industry into the next generation.
              </p>
            </div>
