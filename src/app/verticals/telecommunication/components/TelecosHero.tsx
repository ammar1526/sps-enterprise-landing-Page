  ...
  return (
    <>
      <section className="relative w-full min-h-150 flex items-center bg-slate-900 overflow-hidden">
        <Image
          src="/images/telecos/telecosHerobg.png"
          alt="Telecos Hero"
          fill
        ...
        <div className="relative z-10 container mx-auto px-6 py-16 lg:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            <div className="text-white text-center lg:text-left">
              ...
              <p className="text-sm sm:text-base mb-8 text-slate-100 max-w-3xl mx-auto lg:mx-0 drop-shadow-black drop-shadow-2xl">
                Telecommunications is experiencing a seismic shift and
                communications service providers are evolving to adapt. As
                connectivity services become more commoditized—limiting room for
                differentiation—the opportunity for reinvention is massive
                thanks to technological innovation. Operators today aim to
                capitalize with bold, value-adding enterprise services. SPS
                helps telcos unlock new revenue potential through business and
                delivery transformation by optimizing network operations,
                enabling differentiated enterprise experiences at the edge and
                beyond, and fortifying cybersecurity. At SPS, we are committed
                to helping our customers solve some of networking&apos;s biggest
                challenges.
              </p>
            </div>
