  ...
  return (
    <>
      <section className="relative w-full min-h-150 flex items-center bg-slate-900 overflow-hidden">
        <Image
          src="/images/banking/BankHerobg.jpeg"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            <div className="text-white text-center lg:text-left">
              ...
              <p className="text-sm sm:text-base mb-8 text-slate-100 max-w-3xl mx-auto lg:mx-0 drop-shadow-black drop-shadow-2xl">
                Financial institutions need to modernize to keep pace with
                challenging and changing times. Maintaining and exceeding
                ever-changing customer needs, real-time payments, regulatory
                requirements and cybersecurity risks at reduced cost requires a
                monumental shift. Business transformation built on extreme
                digitalization with new technologies like payments-as-a-service,
                AI, data and the cloud are pivotal. SPS has been a trusted
                partner in the financial services industry for decades. Let us
                help you enhance your customer journey and build new revenue
                streams by utilizing the data you already have on an efficient,
                secure and agile cloud.
              </p>
            </div>
