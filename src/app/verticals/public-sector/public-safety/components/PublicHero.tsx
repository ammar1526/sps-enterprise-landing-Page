          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            <div className="text-white text-center lg:text-left">
              ...
              <p className="text-sm sm:text-base mb-8 text-slate-100 max-w-3xl mx-auto lg:mx-0 drop-shadow-xl">
                The inability to integrate data in the public sector prevents
                state, local, and educational organizations from capturing the
                analytics necessary to have an impact on situational awareness,
                response time, and security. Surveillance systems are
                increasingly difficult to manage, having to support high
                definition cameras, a variety of devices, and longer retention
                times. Video storage often exceeds 30% of the cost of the entire
                system.
              </p>
            </div>
                ...
                <div className="mt-4 flex flex-col gap-3">
                  ...
                  >
                    <span className="font-semibold text-slate-800 text-sm sm:text-base">
                      License Plate Recognition (LPR) Deployment Kit
                    </span>
