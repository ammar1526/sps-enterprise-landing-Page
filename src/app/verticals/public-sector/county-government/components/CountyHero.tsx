      ...
      <div className="relative mt-20 z-10 container mx-auto px-6">
        <div className="max-w-2xl text-white">
          ...
          <p className="text-sm mb-8 text-slate-100 w-3xl drop-shadow-xl">
            ...
            awareness, followed by department-specific Tabletop Exercises that
            reveal risks and modernization opportunities. From refactoring
            legacy systems to unlocking data for AI, we help you build a
            multi-year roadmap aligned with your mission to serve, protect, and
            innovate. Ready to lead the change? Let’s shape your county’s
