      ...
      <div className="relative z-10 container mx-auto px-6 mt-20">
        <div className="max-w-4xl">
          ...
          <p className="text-md text-slate-100 leading-relaxed max-w-2xl drop-shadow-xl">
            The Industry Outreach Program at SpinnLabs is focused on
            understanding the challenges and opportunities faced by the industry
            and help solve them resulting in innovation, entrepreneurship and
            startups.
          </p>
        </div>
      </div>
