...
export default function OverviewAcademia() {
  const sigs = [
    {
      icon: Droplets,
      label: "Innovation in Oil and Gas",
      description: "Digital transformation and optimization in energy sector",
      color: "from-blue-500 to-cyan-400",
    },
    {
      icon: Zap,
      label: "Securing the Electric Grid",
      description: "Cybersecurity and resilience for power infrastructure",
      color: "from-blue-500 to-cyan-400",
    },
    {
      icon: Scissors,
      label: "Innovation in Textile",
      description: "Smart manufacturing and automation in textile industry",
      color: "from-blue-500 to-cyan-400",
    },
    {
      icon: Landmark,
      label: "Banking",
      description: "Fintech innovation and digital banking solutions",
      color: "from-blue-500 to-cyan-400",
    },
    {
      icon: Globe,
      label: "Metaverse",
      description: "Immersive technologies and virtual worlds",
      color: "from-blue-500 to-cyan-400",
    },
  ];
