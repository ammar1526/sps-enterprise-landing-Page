  ...
  return (
    <section className="relative w-full bg-[#0f1f4b] overflow-hidden">
      <div
        ...
        style={{ backgroundImage: "url('/images/about-us/aboutus2.webp')" }}
      />
      ...
      <div className="relative z-10 container mx-auto max-w-350 px-6 py-32 lg:py-44 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg sm:text-xl text-white/90 font-light leading-relaxed mb-8">
          Software Productivity Strategists, Inc. (SPS) is a trusted technology
          partner delivering intelligent, secure, and scalable solutions powered
          by AI, Cloud, and Cybersecurity to accelerate digital
          transformation.r.
        </p>
